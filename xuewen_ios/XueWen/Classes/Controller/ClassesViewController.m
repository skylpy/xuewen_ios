...
//        [self.navigationController pushViewController:[[CollegeViewController alloc] initWithLabelID:model.labelId title:model.labelName] animated:YES];
    }
}
...
- (UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNaviBarH, 100, kHeightNoNaviBarNoTabBar) style:UITableViewStylePlain];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(100,kNaviBarH,kWidth - 100 , kHeightNoNaviBarNoTabBar) collectionViewLayout:flowLayout];
