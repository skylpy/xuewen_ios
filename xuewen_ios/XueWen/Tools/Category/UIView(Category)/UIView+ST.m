 ...
 *  添加边框
 */
- (void)addBorderColor:(UIColor *)color BorderWidth:(CGFloat)width cornerRadius:(CGFloat)radius {
    [self.layer setBorderColor:color.CGColor? :DefaultBorderColor.CGColor];
