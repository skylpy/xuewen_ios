...
typedef enum : NSUInteger {
    ...
    SGIndicatorLengthTypeCustom /// 自定义宽度 /** 自定义  需要先设置 indicatorWidth 指示器宽度 才能生效 */
...
/** 自定义 指示器宽度 需要先设置这个参数 再去设置样式 才能生效 */
@property(assign,nonatomic) NSInteger indicatorWidth ;
/** 指示器 */
